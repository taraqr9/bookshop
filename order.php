...
<body>
 ...
 <div class="h3 container text-success">
   <?php
  ...
  <div class="container-fluid">
    <div class="container">
      <table class="table table-hover">
        ...
        <tbody>
          <?php
          $query = $source->Query("SELECT * FROM `order` WHERE uid = ? ORDER BY oid DESC", [$_SESSION['id']]);
          ...
          if ($numrow > 0) {
            foreach ($details as $row) :
              ...
              if ($row->status === 'Pending') {
                $app = "<a href='delete.php?delete=" . $row->oid . "' class='btn btn-outline-dark mt-2'> Delete</a>";
                ...
                <td>" . $app . " </td>";
                if(!empty($row->bid)){
                  echo "<td class = 'card btn bg-danger text-light ml-5 mt-2'> Old Book</td>";
                }
                echo "</tr>";
